...
const services = [
  ...
  },
  {
    ...
    fullDesc:
      'Keeping your systems safe with reliable, scalable, and future-ready cybersecurity solutions.',
    icon: Shield,
    category: 'Security',
    features: [
  ...
  },
  {
    ...
    features: ['Data & Voice Connectivity',
      ...
      <div className="py-20 bg-gradient-to-b from-white to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14 animate-on-scroll">
            ...
            Empowering businesses with cutting-edge digital and IT services  — from IT, Cloud, Cyber Security, Software, Telecom Services and many more.
            </p>
          </div>
